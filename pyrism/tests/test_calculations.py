...
class TestRISMJobs(unittest.TestCase):
    ...
    def test_cSPCE(self):
        ...
        test_case = np.genfromtxt('outputs/cSPCE/cSPCE.guv', delimiter=',', skip_header=2)[:, 1:].reshape((mol.uv.grid.npts, mol.uv.ns1, mol.uv.ns2))
    ...
    def test_cSPCE_NaCl(self):
        ...
        test_case = np.genfromtxt('outputs/cSPCE_NaCl/cSPCE_NaCl.guv', delimiter=',', skip_header=2)[:, 1:].reshape((mol.uv.grid.npts, mol.uv.ns1, mol.uv.ns2))
    ...
    def test_HR1982N(self):
        ...
        test_case = np.genfromtxt('outputs/HR1982N/HR1982N.guv', delimiter=',', skip_header=2)[:, 1:].reshape((mol.uv.grid.npts, mol.uv.ns1, mol.uv.ns2))
